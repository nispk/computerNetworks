...
def topology(mobility, bw =10, cpu = 0.2):
    ...
    for sched in 'rt', 'cfs':
            ...
            net = Mininet_wifi(link = wmediumd, wmediumd_mode = interference, controller= Controller, station = Station, autoPinCpus = True)
    ...
    #sta1_cpu_limits = CPULimitedStation(sta1, sched='cfs')
    #sta1_cpufraction = sta1_cpu_limits.setCPUFrac(0.2)
    #print ('cpu usage is',sta1_cpufraction)
